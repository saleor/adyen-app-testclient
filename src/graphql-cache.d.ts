...
declare module "gql.tada" {
  interface setupCache {
    "\n  fragment BillingAddress on Address {\n    firstName\n    lastName\n    streetAddress1\n    streetAddress2\n    city\n    postalCode\n    country {\n      code\n    }\n    countryArea\n  }\n": TadaDocumentNode<
      ...
      {},
      { fragment: "BillingAddress"; on: "Address"; masked: true }
    >;
    "\n  fragment ShippingMethod on ShippingMethod {\n    id\n    name\n    price {\n      amount\n      currency\n    }\n  }\n": TadaDocumentNode<
      { id: string; name: string; price: { amount: number; currency: string } },
      {},
      { fragment: "ShippingMethod"; on: "ShippingMethod"; masked: true }
    >;
    "\n  fragment DeliveryMethod on ShippingMethod {\n    id\n  }\n": TadaDocumentNode<
      { id: string },
      {},
      { fragment: "DeliveryMethod"; on: "ShippingMethod"; masked: true }
    >;
    "\n  fragment CollectionPoint on Warehouse {\n    id\n  }\n": TadaDocumentNode<
      { id: string },
      {},
      { fragment: "CollectionPoint"; on: "Warehouse"; masked: true }
    >;
    "\n  fragment ShippingAddress on Address {\n    firstName\n    lastName\n    streetAddress1\n    city\n    postalCode\n    country {\n      code\n    }\n    countryArea\n  }\n": TadaDocumentNode<
      ...
      {},
      { fragment: "ShippingAddress"; on: "Address"; masked: true }
    >;
    "\n    query getCheckout($checkoutId: ID!) {\n      checkout(id: $checkoutId) {\n        billingAddress {\n          ...BillingAddress\n        }\n        shippingAddress {\n          ...ShippingAddress\n        }\n        shippingMethods {\n          ...ShippingMethod\n        }\n        deliveryMethod {\n          ...DeliveryMethod\n          ...CollectionPoint\n        }\n      }\n    }\n  ": TadaDocumentNode<
      {
        checkout: {
          billingAddress: {
            [$tada.fragmentRefs]: { BillingAddress: "Address" };
          } | null;
          shippingAddress: {
            [$tada.fragmentRefs]: { ShippingAddress: "Address" };
          } | null;
          shippingMethods: {
            [$tada.fragmentRefs]: { ShippingMethod: "ShippingMethod" };
          }[];
          deliveryMethod:
            | {
                __typename?: "ShippingMethod" | undefined;
                [$tada.fragmentRefs]: { DeliveryMethod: "ShippingMethod" };
              }
            | {
                __typename?: "Warehouse" | undefined;
                [$tada.fragmentRefs]: { CollectionPoint: "Warehouse" };
              }
            | null;
        } | null;
      },
    ...
    "\n  mutation updateBillingAddress($checkoutId: ID!, $input: AddressInput!) {\n    checkoutBillingAddressUpdate(\n      checkoutId: $checkoutId\n      billingAddress: $input\n    ) {\n      errors {\n        field\n        message\n      }\n    }\n  }\n": TadaDocumentNode<
      ...
      {
        input: {
          metadata?: { value: string; key: string }[] | null | undefined;
    ...
    "\n  mutation checkoutDeliveryMethodUpdate($checkoutId: ID!, $input: ID!) {\n    checkoutDeliveryMethodUpdate(id: $checkoutId, deliveryMethodId: $input) {\n      errors {\n        field\n        message\n      }\n    }\n  }\n": TadaDocumentNode<
      ...
      { input: string; checkoutId: string },
      void
    >;
    ...
    "\n  fragment TotalPrice on TaxedMoney {\n    gross {\n      amount\n      currency\n    }\n  }\n": TadaDocumentNode<
      ...
      {},
      { fragment: "TotalPrice"; on: "TaxedMoney"; masked: true }
    >;
    "\n    query GetCheckoutTotalPrice($checkoutId: ID!) {\n      checkout(id: $checkoutId) {\n        totalPrice {\n          ...TotalPrice\n        }\n      }\n    }\n  ": TadaDocumentNode<
      {
        checkout: {
          totalPrice: { [$tada.fragmentRefs]: { TotalPrice: "TaxedMoney" } };
        } | null;
      },
      { checkoutId: string },
      void
    ...
    "\n  mutation InitalizePaymentGateway(\n    $checkoutId: ID!\n    $paymentGatewayId: String!\n    $amount: PositiveDecimal!\n  ) {\n    paymentGatewayInitialize(\n      id: $checkoutId\n      paymentGateways: [{ id: $paymentGatewayId }]\n      amount: $amount\n    ) {\n      gatewayConfigs {\n        id\n        data\n        errors {\n          field\n          message\n          code\n        }\n      }\n      errors {\n        field\n        message\n        code\n      }\n    }\n  }\n": TadaDocumentNode<
            ...
            | {
                ...
                errors:
                  | {
                      field: string | null;
                      message: string | null;
                      code: "GRAPHQL_ERROR" | "INVALID" | "NOT_FOUND";
                    }[]
                  | null;
              }[]
            | null;
      ...
      { amount: unknown; paymentGatewayId: string; checkoutId: string },
      void
    >;
    ...
    "\n  mutation TransactionProcess($transactionId: ID!, $data: JSON) {\n    transactionProcess(id: $transactionId, data: $data) {\n      transaction {\n        id\n        actions\n        message\n        pspReference\n        events {\n          type\n          id\n          createdAt\n          message\n          pspReference\n        }\n      }\n      data\n      errors {\n        field\n        message\n        code\n      }\n    }\n  }\n": TadaDocumentNode<
      ...
      { data?: unknown; transactionId: string },
      void
    >;
        ...
        input: {
          validationRules?:
            | {
                billingAddress?:
                  | {
                      enableFieldsNormalization?: boolean | null | undefined;
                      checkFieldsFormat?: boolean | null | undefined;
                      checkRequiredFields?: boolean | null | undefined;
                    }
                  | null
                  | undefined;
                shippingAddress?:
    ...
    "\n  fragment Product on Product {\n    id\n    name\n    thumbnail(size: 2048) {\n      url\n    }\n    category {\n      name\n    }\n    defaultVariant {\n      id\n      pricing {\n        price {\n          gross {\n            amount\n            currency\n          }\n        }\n      }\n    }\n  }\n": TadaDocumentNode<
      ...
      {},
      { fragment: "Product"; on: "Product"; masked: true }
    >;
    "\n    query FetchProduct($channelSlug: String!) {\n      products(\n        first: 1\n        channel: $channelSlug\n        filter: {\n          isPublished: true\n          stockAvailability: IN_STOCK\n          giftCard: false\n        }\n        sortBy: { field: PRICE, direction: DESC }\n      ) {\n        edges {\n          node {\n            ...Product\n          }\n        }\n      }\n    }\n  ": TadaDocumentNode<
      {
        products: {
          edges: { node: { [$tada.fragmentRefs]: { Product: "Product" } } }[];
        } | null;
      },
      { channelSlug: string },
      void
    ...
    "\n  fragment PaymentGateway on PaymentGateway {\n    id\n    name\n  }\n": TadaDocumentNode<
      ...
      {},
      { fragment: "PaymentGateway"; on: "PaymentGateway"; masked: true }
    >;
    "\n    query GetPaymentGateways($checkoutId: ID!) {\n      checkout(id: $checkoutId) {\n        totalPrice {\n          ...TotalPrice\n        }\n        availablePaymentGateways {\n          ...PaymentGateway\n        }\n      }\n    }\n  ": TadaDocumentNode<
      {
        checkout: {
          totalPrice: { [$tada.fragmentRefs]: { TotalPrice: "TaxedMoney" } };
          availablePaymentGateways: {
            [$tada.fragmentRefs]: { PaymentGateway: "PaymentGateway" };
          }[];
        } | null;
      },
      { checkoutId: string },
    ...
    "\n  fragment Checkout on Checkout {\n    id\n    created\n    billingAddress {\n      firstName\n      lastName\n      streetAddress1\n      city\n      postalCode\n      country {\n        code\n        country\n      }\n      countryArea\n      phone\n    }\n    shippingAddress {\n      firstName\n      lastName\n      streetAddress1\n      city\n      postalCode\n      countryArea\n      country {\n        code\n        country\n      }\n      phone\n    }\n    email\n    totalPrice {\n      gross {\n        amount\n      }\n      currency\n    }\n    subtotalPrice {\n      gross {\n        amount\n      }\n      currency\n    }\n    shippingPrice {\n      gross {\n        amount\n      }\n      currency\n    }\n    lines {\n      id\n      variant {\n        product {\n          name\n        }\n      }\n      quantity\n      totalPrice {\n        gross {\n          amount\n        }\n        currency\n      }\n    }\n  }\n": TadaDocumentNode<
      ...
      {},
      { fragment: "Checkout"; on: "Checkout"; masked: true }
    >;
    ...
    >;
    "\n    query getCheckout($checkoutId: ID!) {\n      checkout(id: $checkoutId) {\n        ...Checkout\n      }\n    }\n  ": TadaDocumentNode<
      { checkout: { [$tada.fragmentRefs]: { Checkout: "Checkout" } } | null },
      { checkoutId: string },
      void
    >;
  }
